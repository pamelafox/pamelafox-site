...
def test_get_blogger_data():
    ...
    with unittest.mock.patch.object(urllib.request, "urlopen", return_value=data):
        ...
        assert rows == [{'link': 'http://blog.pamelafox.org/2022/06/how-accessibility-helps-nursing-mother.html', 'title': 'How accessibility helps a nursing mother'}]
...
def test_get_blogger_data_with_tag():
    ...
    with unittest.mock.patch.object(urllib.request, "urlopen", return_value=data) as mocked:
        ...
        assert mocked.call_args.args[0] == 'http://www.blogger.com/feeds/8501278254137514883/posts/default?max-results=150&alt=json&category=a11y'
        assert tag == 'a11y'
